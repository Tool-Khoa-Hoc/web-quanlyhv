...
// Tạo group cấp 1 (Tôi yêu ngoại ngữ) + 5 group cấp 2 (IELTS, Tiếng Nhật,
// Tiếng Hàn, Tiếng Trung, TOEIC) rồi share folder Drive tương ứng cho từng
// group với quyền reader.
//
// Group cấp 1 share folder cha "1. TÔI YÊU NGOẠI NGỮ" (bao trùm toàn bộ khóa
// con). Mỗi group cấp 2 share đúng folder combo của nó.
//
// Idempotent: group đã tồn tại thì bỏ qua tạo; share đã đúng quyền thì bỏ qua.
//
// Usage:
//   node scripts/create-ngoai-ngu-groups.mjs            # LIVE
//   node scripts/create-ngoai-ngu-groups.mjs --dry-run  # chỉ in, không ghi
...
const GROUPS = [
  // ----- Cấp 1: bao trùm toàn bộ ngoại ngữ -----
  {
    local: "nn-toi-yeu-ngoai-ngu",
    name: "Tôi yêu ngoại ngữ",
    folders: ["1y35CZvcq-v2a-cyl_Zxo-0NG85WTDsbF"],
  },

  // ----- Cấp 2: từng combo -----
  { local: "nn-ielts", name: "COMBO IELTS", folders: ["1gr-FfpkMmfPTiHu1o-w_e9xmlu4CklWg"] },
  { local: "nn-tieng-nhat", name: "COMBO TIẾNG NHẬT", folders: ["1smvW-PJOJ246Axixk3RpVeMWcvuIF8yY"] },
  { local: "nn-tieng-han", name: "KHÓA HỌC TIẾNG HÀN", folders: ["1H6QBPc3mEuvz7Z6OmZ9fKch1-kPfb5c0"] },
  { local: "nn-tieng-trung", name: "KHÓA HỌC TIẾNG TRUNG", folders: ["1TQoeBjMUh-en1cEjx3nzG4-3cqSxjeJI"] },
  { local: "nn-toeic", name: "KHÓA HỌC TOEIC", folders: ["1uwZRW-aROEmohx4HzYzCNQalxkGjXvrn"] },
];
